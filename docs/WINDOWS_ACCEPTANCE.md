...
2026-09-20 自动验收记录：提交 `a408da77e87fec8e75fdda84b4d130b9afdebddd` 的 [Windows 构建 35495536630](https://github.com/rocaka/trainer/actions/runs/35495536630) 已全部通过，包括真实系统凭据假数据测试、冻结后台、NSIS 安装、桌面窗口、后台健康及关闭回收。以下手工业务/视觉和正式发布门槛仍待验收。
